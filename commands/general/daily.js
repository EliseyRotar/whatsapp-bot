...
// Ruota della fortuna prizes - BUFFED for better player engagement
const WHEEL_PRIZES = [
    { coins: 200, emoji: '💰', weight: 20 },      // 20% chance (was 50)
    { coins: 500, emoji: '💵', weight: 25 },      // 25% chance (was 100)
    { coins: 1000, emoji: '💸', weight: 20 },     // 20% chance (was 200)
    { coins: 2500, emoji: '💎', weight: 15 },     // 15% chance (was 500)
    { coins: 5000, emoji: '🏆', weight: 10 },     // 10% chance (was 1000)
    { coins: 10000, emoji: '👑', weight: 7 },     // 7% chance (was 2500)
    { coins: 25000, emoji: '⭐', weight: 2.5 },   // 2.5% chance (was 5000)
    { coins: 50000, emoji: '🌟', weight: 0.5 }    // 0.5% chance - MEGA JACKPOT! (was 10000)
];

const responses = {
    en: {
        usage: '🎡 WHEEL OF FORTUNE\n\nSpin the daily wheel for prizes!\n\nUsage: .daily\n\nPossible Prizes:\n💰 200 coins (20%)\n💵 500 coins (25%)\n💸 1,000 coins (20%)\n💎 2,500 coins (15%)\n🏆 5,000 coins (10%)\n👑 10,000 coins (7%)\n⭐ 25,000 coins (2.5%)\n🌟 50,000 coins (0.5%) MEGA JACKPOT!\n\nSpin once every 24 hours!',
...
export default {
    ...
    execute: async (sock, msg, args) => {
        ...
        if (result.success) {
            ...
            // Show final result
            const isJackpot = prize.coins >= 25000; // Updated threshold for mega prizes
